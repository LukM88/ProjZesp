...
public class MyDate {
    ...
    public MyDate(){
        String currentDateTimeString = java.text.DateFormat.getDateInstance(DateFormat.SHORT).format(new Date());
        String currentDateTimeString2 = java.text.DateFormat.getDateInstance(DateFormat.DEFAULT).format(new Date());
        this.day=currentDateTimeString.substring(currentDateTimeString.length()-5,currentDateTimeString.length()-3);
        this.month=currentDateTimeString.substring(0,currentDateTimeString.length()-6);;
        this.year=currentDateTimeString2.substring(currentDateTimeString2.length()-4,currentDateTimeString2.length());;
